...
export const _myAccount = {
  ...
  photoURL: '/assets/images/avatar/avatar-25.jpeg',
};
...
export const _notifications = [
  ...
  },
  {
    id: _id(2),
    title: _fullName(2),
    description: 'respondeu ao seu comentário no Minimal',
  ...
  },
  {
    ...
    description: 'enviado de Guido Padberg',
    avatarUrl: null,
    type: 'mail',
    postedAt: _times(4),
    isUnRead: false,
